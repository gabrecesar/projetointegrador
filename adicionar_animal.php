  ...
  <div class="row">
    <div class="col-md-6">
      <form action="adicionar_animal.php" method="POST">
        ...
        <div class="form-floating">
          <label for="floatingInput"></label>
          <input type="number" name="peso" class="form-control"  placeholder="">
        </div>
        <br>
        Idade
        <br>
        <div class="form-floating">
          <label for="floatingInput"></label>
          <input type="number" name="idade" class="form-control" placeholder="">
        </div>
        <br>
        Alimentação
    ...
    <div class="col-md-6">
      ...
      <div class="container text-center">
        <div class="form-floating">
          Adicionar uma foto
          <label for="floatingInput"></label>
          <input type="file" name ="foto" class="form-control" id="floatingInput" placeholder="Adicionar uma foto">
        </div>
</br></br>
     <div class="container text-center">
     <input type="submit" name="grava" value="Adicionar animal" class="btn btn-success">
        </div>
</form>
<br><br><br>
<div class="container text-center">
...
if(isset($_POST['grava'])){
    ...
    $grava=$conn->prepare('INSERT INTO `animal` (`idanimal`, `idclasse`, `idusuario`, `nm_animal`, `sexo_animal`, 
    `especie_animal`, `idade_animal`, `peso_animal`, `alimentacao_animal`, `higiene_animal`, `foto_animal`, `ver_cart_animal`) 
    VALUES (NULL, 
    2, 18, :pnome, :psexo, :pespecie, :pidade, :ppeso, :palimentacao, :phigiene, NULL, :pver_cart);');
    $grava->bindValue(':pnome',$nome);
    $grava->bindValue(':psexo',$sexo);
    $grava->bindValue(':pespecie',$especie);
    $grava->bindValue(':pidade',$idade);
    $grava->bindValue(':ppeso',$peso);
    $grava->bindValue(':palimentacao',$alimentacao);
    $grava->bindValue(':phigiene',$higiene);
    $grava->bindValue(':pver_cart',$ver_cart);
    $grava->execute();
